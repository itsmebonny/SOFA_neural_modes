            ...
            with torch.no_grad():
                ...
                def closure():
                    ...
                    if iteration % print_every == 0:
                        ...
                        # Print ground truth energy if available
                        if ground_truth_energy is not None:
                            mean_gt_energy_for_print = torch.mean(ground_truth_energy.squeeze()).item()
                            print(f"│ {'GT Energy (mean):':<20} {mean_gt_energy_for_print:<12.6f}")
                        else:
                            print(f"│ {'GT Energy (mean):':<20} {'N/A':<12}")     
                        ...
                        print(f"│ {'BC Penalty:':<20} {bc_penalty.item():<12.6e} │ {'MSE Displacement:':<20} {mse_displacement_loss_term.item():<12.6e}")
                        print(f"│ {'MSE Energy:':<20} {mse_energy_loss_term.item():<12.6e} │ {'Total Loss:':<20} {loss.item():<12.6e}")     
